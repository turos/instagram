...
function translate(sentence) {
  ...
  for(i=0;i<sentence.length;i++){
    if (sentence[i].match(/[bcdfghjklmnpqrstvxzBCDFGHJKLMNPQRSTVXZ]/)){
      new_sentence = new_sentence + sentence[i] + "o" + sentence[i];
    }
    else{
      //it's a vowel or a space
      new_sentence = new_sentence + sentence[i];
    }
  }
  console.log(sentence + " in robberlingo is: "  + new_sentence);
